...
public partial class NhsBookStoreContext : DbContext
{
    public NhsBookStoreContext()
    {
    }

    public NhsBookStoreContext(DbContextOptions<NhsBookStoreContext> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=HAISON\\SQL1;Database=NhsBookStore;uid=sa;pwd=Zuboka@05; MultipleActiveResultSets=True; TrustServerCertificate=True ");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Account>(entity =>
        {
            entity.HasKey(e => e.AccountId).HasName("PK__Account__349DA5A6E79012A7");
        ...
        {
            entity.HasKey(e => e.BookId).HasName("PK__Book__3DE0C207137F116D");
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__Category__19093A0BA5B3488A");
        ...
        {
            entity.HasKey(e => e.OrderId).HasName("PK__OrderBoo__C3905BCFD7441C32");
        ...
        {
            entity.HasKey(e => e.OrderDetailId).HasName("PK__OrderDet__D3B9D36C9E4D47FD");
        ...
        {
            entity.HasKey(e => e.PublisherId).HasName("PK__Publishe__4C657FABC9A29C22");
